...
class BeefcakeLookAndFeel : public juce::LookAndFeel_V4
{
public:
...
public:
    ...
    ~FiveParksVST3AudioProcessorEditor() override;
...
private:
    ...
    void addMatrixSlot(int row, juce::ComboBox& src, juce::ComboBox& dst, SerumKnob& amt,
                       const juce::String& srcId, const juce::String& dstId, const juce::String& amtId);
    void tintKnobGroup(std::initializer_list<SerumKnob*> knobs, juce::Colour colour);

    FiveParksVST3AudioProcessor& audioProcessor;
    BeefcakeLookAndFeel beefcakeLookAndFeel;
